/*! For license information please see main.7e9d3110.js.LICENSE.txt */
!(function () {
  var e = {
      472: function (e) {
      ...
      463: function (e, t, n) {
        ...
        var Eu,
          ...
          Zu = 0;
        function es() {
          return 0 !== (6 & Pu) ? Ge() : -1 !== Xu ? Xu : (Xu = Ge());
        }
        function ts(e) {
          return 0 === (1 & e.mode)
            ? 1
        ...
        function Hs(e, t, n, r, a, o, l, i, u) {
          return (
            ((e = Is(n, r, !0, e, 0, o, 0, i, u)).context = Vs(null)),
            (n = e.current),
  ...
  !(function () {
    ...
    function f() {
      ...
      function c(e, t, n, r) {
        var o = t && t.prototype instanceof h ? t : h,
          ...
          i = new N(r || []);
        return a(l, "_invoke", { value: E(e, n, i) }), l;
      }
      function d(e, t, n) {
        try {
    ...
    var re = W.toFlatObject(W, {}, null, function (e) {
      ...
      function c(e, n, r) {
        ...
        if (e && !r && "object" === typeof e)
          if (W.endsWith(n, "{}"))
            ...
            (W.isArray(e) &&
              (function (e) {
                return W.isArray(e) && !e.some(ee);
              })(e)) ||
            W.isFileList(e) ||
            (W.endsWith(n, "[]") && (o = W.toArray(e)))
          )
            return (
              (n = te(n)),
              o.forEach(function (e, r) {
                !W.isUndefined(e) &&
                  null !== e &&
                  t.append(
                    !0 === i ? ne([n], r, l) : null === i ? n : n + "[]",
                    s(e)
                  );
              }),
              !1
            );
        return !!ee(e) || (t.append(ne(r, n, l), s(e)), !1);
      }
      var f = [],
        d = Object.assign(re, {
          defaultVisitor: c,
              ...
              W.forEach(n, function (n, a) {
                !0 ===
                  (!(W.isUndefined(n) || null === n) &&
                    o.call(t, n, W.isString(a) ? a.trim() : a, r, d)) &&
                  e(n, r ? r.concat(a) : [a]);
              }),
              f.pop();
          }
    ...
    var fe = (function () {
      ...
      ye = {
        isBrowser: !0,
        classes: { URLSearchParams: pe, FormData: he, Blob: Blob },
        isStandardBrowserEnv: me,
    ...
    var ge = function (e) {
        function t(e, n, r, a) {
          ...
          return (
            ...
            i
              ? (W.hasOwnProp(r, o) ? (r[o] = [r[o], n]) : (r[o] = n), !l)
    ...
    function Ce(e) {
      return !1 === e || null == e ? e : W.isArray(e) ? e.map(Ce) : String(e);
    }
    function _e(e, t, n, r) {
        ...
        K(
          ...
          [
            ...
            },
            {
              key: "accessor",
              value: function (e) {
                var t = (this[Ee] = this[Ee] = { accessors: {} }).accessors,
                  n = this.prototype;
                function r(e) {
                  var r = xe(e);
                  t[r] ||
    ...
    W.inherits(Re, X, { __CANCEL__: !0 });
    var Le = Re;
    var ze = ye.isStandardBrowserEnv
      ? {
          ...
          return new Promise(function (t, n) {
            ...
            void 0 === a && o.setContentType(null),
              "setRequestHeader" in u &&
                W.forEach(o.toJSON(), function (e, t) {
    ...
    var Ue = function (e) {
      for (
        var t, n, r = (e = W.isArray(e) ? e : [e]).length, a = 0;
        a < r && ((t = e[a]), !(n = W.isString(t) ? Me[t.toLowerCase()] : t));
        a++
      );
      if (!n) {
        if (!1 === n)
    ...
    function Be(e) {
      return (
        ...
        Ue(e.adapter || ke.adapter)(e).then(
          function (t) {
            return (
              Ie(e),
          ...
          K(e, [
            {
              ...
              value: function (e, t) {
                ...
                void 0 !== a &&
                  ...
                  (n = l && W.merge(l.common, l[t.method])) &&
                    W.forEach(
                      [
                        "delete",
                        "get",
      ...
      Ge = (function () {
        function e(t) {
          ...
          this.promise.then(function (e) {
            ...
            t(function (e, t, a) {
              r.reason || ((r.reason = new Le(e, t, a)), n(r.reason));
            });
        }
        return (
          K(
    ...
    var et = (function e(t) {
      var n = new Ye(t),
        r = m(Ye.prototype.request, n);
      return (
        W.extend(r, Ye.prototype, n, { allOwnKeys: !0 }),
        ...
        var n = t.users,
          ...
          i = n.sort(function (e, t) {
            return "userName" === o
              ...
              : "firstName" === o
              ? e.firstName.localeCompare(t.firstName)
              : "lastName" === o
              ? e.lastName.localeCompare(t.lastName)
              : e.age - t.age;
          });
        return (0, nt.jsxs)("div", {
          children: [
            (0, nt.jsx)("h1", { children: "Users" }),
            (0, nt.jsxs)("div", {
              children: [
                (0, nt.jsx)("label", {
                  htmlFor: "sort-by",
                ...
                (0, nt.jsxs)("select", {
                  ...
                  children: [
                    ...
                    (0, nt.jsx)("option", { value: "age", children: "Age" }),
                  ],
                }),
                (0, nt.jsxs)("table", {
                  children: [
                    (0, nt.jsx)("tbody", {
                      children: (0, nt.jsxs)("tr", {
                        children: [
                          (0, nt.jsx)("th", { children: "username" }),
                          (0, nt.jsx)("th", { children: "first Name" }),
                          (0, nt.jsx)("th", { children: "last Name" }),
                          (0, nt.jsx)("th", { children: "email" }),
                          (0, nt.jsx)("th", { children: "age" }),
                          (0, nt.jsx)("th", { children: "delete" }),
                        ],
                      }),
                    }),
                    (0, nt.jsx)("tbody", {
                      children: i.map(function (e) {
                        return (0, nt.jsxs)(
                          ...
                          {
                            children: [
                              (0, nt.jsx)("td", { children: e.userName }),
                              (0, nt.jsx)("td", { children: e.firstName }),
                              (0, nt.jsx)("td", { children: e.lastName }),
                              (0, nt.jsx)("td", { children: e.email }),
                              (0, nt.jsx)("td", { children: e.age }),
                              (0, nt.jsx)("td", {
                                children: (0, nt.jsx)("button", {
                                  onClick: function () {
                                    return r(e._id);
                                  },
                                  children: "Delete",
                ...
                return f().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.next = 2), tt.get("http://localhost:5001/user")
                        );
                      case 2:
                        (t = e.sent), r(t.data);
                      case 4:
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (
                            alert(
                              "Entry cannot be empty. Please enter all the details."
                            ),
                            e.abrupt("return")
                          );
                        case 5:
                          if (
                            !n.find(function (e) {
                              return e.email.toLowerCase() === s.toLowerCase();
                            })
                          ) {
                            e.next = 9;
                            break;
                        ...
                        case 9:
                          return (
                            (e.prev = 9),
                            (e.next = 12),
                            tt.post("http://localhost:5001/user", o)
                          );
                        case 12:
                          r([].concat(c(n), [o])),
                        ...
                        case 18:
                          (e.prev = 18),
                            (e.t0 = e.catch(9)),
                            console.error(e.t0),
                            11e3 === e.t0.response.data.code
                              ? alert("This information is already in use.")
                              : alert(
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          console.log(
                            "delete URL: ",
                            "http://localhost:5001/user/".concat(t)
                          ),
                          (e.next = 4),
                          tt.delete("http://localhost:5001/user/".concat(t))
                        );
                      case 4:
                        r(
                          n.filter(function (e) {
        ...
        return (0, nt.jsxs)("div", {
          ...
          children: [
            (0, nt.jsxs)("div", {
              className: "header",
              children: [
                (0, nt.jsx)("h1", { children: "User Management App" }),
                (0, nt.jsx)("p", {
                  children:
                    "This app is built using React on the front end, and powered by NodeJS, Express, and MongoDB on the back end. With this app, you can easily add and delete users, and order them according to different criteria, including username, first name, last name, and age. The user-friendly interface makes it easy to manage your users, and the back end ensures the data is securely stored and can be retrieved quickly.",
                }),
              ],
            }),
            (0, nt.jsxs)("form", {
                  ...
                  children: [
                    ...
                    (0, nt.jsx)("label", {
                      children: (0, nt.jsx)("input", {
                        ...
                        onChange: function (e) {
                          return l(
                            i(i({}, o), {}, { firstName: e.target.value })
                          );
                        },
                      }),
                    }),
                    ...
                    (0, nt.jsx)("label", {
                      children: (0, nt.jsx)("input", {
                        ...
                        value: o.email,
                        onChange: function (e) {
                          return l(i(i({}, o), {}, { email: e.target.value }));
                        },
                      }),
                    }),
                    (0, nt.jsxs)("label", {
            ...
            (0, nt.jsx)(rt, { users: n, handleDelete: v }),
          ],
        });
      };
    t.createRoot(document.getElementById("root")).render(
      (0, nt.jsx)(e.StrictMode, { children: (0, nt.jsx)(at, {}) })
    );
  })();
})();
//# sourceMappingURL=main.7e9d3110.js.map
